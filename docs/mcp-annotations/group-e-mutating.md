...
for the **state-mutating** (write) tools of the LongPort MCP server. Each annotation
...
- **openWorldHint = true** — the tool interacts with an external system (the LongPort brokerage / community / OpenAPI backend) rather than a closed local environment.

Every tool in this group sets `openWorldHint = true` because each one issues an
authenticated HTTPS request to a LongPort backend (trade gateway, quote/watchlist
...
- **Open World = true** — Performs an OAuth token exchange against the LongPort authorization backend.
...
- **Open World = true** — Writes to the LongPort watchlist service.
...
- **Open World = true** — Writes to the LongPort alert service.
...
- **Open World = true** — Writes to the LongPort community backend.
...
- **Open World = true** — Writes to the LongPort DCA/trade service.
...
- **Open World = true** — Writes to the LongPort community sharelist service.
...
- **Open World = true** — Mutates the LongPort watchlist service.
...
- **Open World = true** — Mutates state on the LongPort trade gateway.
...
- **Open World = true** — Mutates the LongPort alert service.
...
- **Open World = true** — Mutates the LongPort DCA service.
...
- **Open World = true** — Mutates the LongPort community sharelist service.
...
- **Open World = true** — Submits to the LongPort trade gateway.
