...
- **openWorldHint = true** — the tool interacts with entities outside this
  server: it reaches the LongPort real-time quote / market backend over the
...
- **Open World = true** — Reads listing/reference data from the LongPort backend over the network; the data is maintained externally by exchanges/LongPort.
...
- **Open World = true** — Quote values come from the live LongPort quote feed over the network and change continuously with the market, outside server control.
...
- **Open World = true** — Option quotes and Greeks are sourced live from the LongPort backend over the network and vary with the market.
...
- **Open World = true** — Warrant quotes are fetched live from the LongPort backend over the network and change with the market.
...
- **Open World = true** — Order-book depth is live exchange data delivered through the LongPort backend over the network, controlled by the market.
...
- **Open World = true** — Broker-queue data originates from HKEX via the LongPort backend over the network and changes with the market.
...
- **Open World = true** — The participant directory is maintained externally and retrieved from the LongPort backend over the network.
...
- **Open World = true** — Trade ticks are live exchange data served by the LongPort backend over the network.
...
- **Open World = true** — Intraday data is sourced live from the LongPort backend over the network and updates with the trading session.
...
- **Open World = true** — Candlestick data comes from the LongPort backend over the network and reflects external market activity.
...
- **Open World = true** — Historical candles are fetched from the LongPort backend over the network; the underlying data is externally maintained.
...
- **Open World = true** — Historical data is retrieved from the LongPort backend over the network, controlled by the exchange/LongPort.
...
- **Open World = true** — The trading calendar is maintained externally and served from the LongPort backend over the network.
...
- **Open World = true** — Expiry data is fetched from the LongPort backend over the network and reflects externally listed contracts.
...
- **Open World = true** — Chain quotes and Greeks are live data from the LongPort backend over the network and change with the market.
...
- **Open World = true** — Capital-flow data is computed externally and served from the LongPort backend over the network.
...
- **Open World = true** — Distribution data is sourced from the LongPort backend over the network and reflects live market flow.
...
- **Open World = true** — Session schedules are defined by the exchanges and retrieved from the LongPort backend over the network.
...
- **Open World = true** — The temperature is computed externally and served live from the LongPort backend over the network.
...
- **Open World = true** — Historical sentiment data is fetched from the LongPort backend over the network.
...
- **Open World = true** — The watchlist is stored in the user's LongPort account and retrieved from the backend over the network.
...
- **Open World = true** — Filing data originates from regulators and is served from the LongPort backend over the network.
...
- **Open World = true** — The issuer directory is maintained externally and fetched from the LongPort backend over the network.
...
- **Open World = true** — Warrant listings and quotes are live data from the LongPort backend over the network.
...
- **Open World = true** — Inputs are live market values fetched from the LongPort backend over the network, so outputs change with the market.
...
- **Open World = true** — The security universe is maintained externally and served from the LongPort backend over the network.
...
- **Open World = true** — Market status reflects live exchange state delivered by the LongPort backend over the network.
...
- **Open World = true** — FX rates are sourced externally and served live from the LongPort backend over the network.
...
- **Open World = true** — A/H premium data is derived from live cross-market prices via the LongPort backend over the network.
...
- **Idempotent = true** — Repeated calls re-read the series with no side effects.
- **Open World = true** — Intraday premium values reflect live market prices from the LongPort backend over the network.
...
- **Open World = true** — Trade statistics are computed from live market data and served from the LongPort backend over the network.
...
- **Open World = true** — Anomaly detection runs externally and results are served live from the LongPort backend over the network.
...
- **Open World = true** — Constituent and allocation data are maintained externally and fetched from the LongPort backend over the network.
...
- **Open World = true** — Short-interest data originates from FINRA (US) and HKEX (HK) and is served from the LongPort backend over the network.
...
- **Open World = true** — Option-volume stats are live data from the LongPort backend over the network and change with the market.
...
- **Open World = true** — Daily option stats are fetched from the LongPort backend over the network and reflect external market data.
...
- **Open World = true** — Top-mover events are computed externally from live market data and served from the LongPort backend over the network.
